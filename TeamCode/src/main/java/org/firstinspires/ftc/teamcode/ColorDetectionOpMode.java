...
@Autonomous(name = "Color Detection -Aarya")
public class ColorDetectionOpMode extends OpMode {
    ...
    public void init() {
        ...
        leftFront = hardwareMap.get(DcMotor.class, "left_Motor1");
        leftRear = hardwareMap.get(DcMotor.class, "left_Motor2");
        rightFront = hardwareMap.get(DcMotor.class, "right_Motor1");
        rightRear = hardwareMap.get(DcMotor.class, "right_Motor2");
    ...
    public void start() {
        ...
        switch (recordedPropPosition) {
            case LEFT:
                telemetry.addData("CASE SELECTED", "LEFT");
                telemetry.update();
                break;

            case MIDDLE:
                telemetry.addData("CASE SELECTED", "MIDDLE");
                telemetry.update();
                break;

            case RIGHT:
                telemetry.addData("CASE SELECTED", "RIGHT");
                telemetry.update();
                break;

            case UNFOUND:
                telemetry.addData("CASE SELECTED", "UNFOUND");
                telemetry.update();
                break;
        }
    }
